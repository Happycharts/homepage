---
title: Concepts
description: The core concepts of Happybase
---

# Core Concepts of Happybase

Happybase is designed to be a versatile and powerful platform for data sharing and commercialization. This document outlines the core concepts that make Happybase unique and effective: Commerce (Stripe Connect), Payment Links, and Portals.

## Commerce: Stripe Connect

### What is Stripe Connect?

Stripe Connect is a powerful platform that allows businesses to accept payments and manage payouts globally. Happybase integrates Stripe Connect to facilitate secure and efficient transactions, enabling users to monetize their data seamlessly.

### How Stripe Connect Works in Happybase

1. **Account Setup**: Users can easily set up a Stripe Connect account through the Happybase platform. This account will be used to manage all financial transactions related to data sharing.
...
- **Ease of Use**: The integration of Stripe Connect into Happybase makes it simple for users to set up and manage their payments and payouts.
...
Portals in Happybase are endlessly flexible environments created using IFrames. These portals can be tailored to fit the specific needs of different users and applications, providing a flexible and powerful data-sharing solution.
...
2. **Isolation**: Each portal operates as an independent web page within the main Happybase interface. This isolation ensures that data and code from one portal do not interfere with others.
